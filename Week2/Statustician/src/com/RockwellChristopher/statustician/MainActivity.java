...
public class MainActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneStateLis = new PhoneStateListener() {
        	...
        	public void onCallStateChanged(int state, String incomingNumber) {
        		...
        		phoneTv.setText(Html.fromHtml("<font color=\"#545454\"><b>Phone Type: </b></font>" + typeStr + 
        				"<br /><font color=\"#545454\"><b>Phone State: </b></font>" + stateStr + "<br />" +
        				"<font color=\"#545454\"><b>Incoming Number: </b></font>" + inNum + "<br />" +
        				"<font color=\"#545454\"><b>Rang: </b></font>" + numRings + " times"));
        	}
        };
	...
	private void getBatteryStatus() {
		...
		if (lev > 0 && scale > 0) {
			...
			batteryTv.setText(Html.fromHtml("<font color=\"#545454\"><b>Battery Level: </b></font>" + percentage + "% <br />"
								+ "<font color=\"#545454\"><b>Battery Health: </b></font>" + getBatteryHealthStr(healthCode)));
		}
	}
	...
	private boolean isMyServiceRunning() {
	    ...
	    for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
	        if ("com.RockwellChristopher.statustician.BatteryService".equals(service.service.getClassName())) {
	            return true;
	        }
	    }
	    return false;
	...
	private void getConnectionInfo() {
		...
		networkTv.setText(Html.fromHtml("<font color=\"#545454\"><b>Mobile Data: </b></font>" + connStr));
	}
}
